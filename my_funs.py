# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 12:06:10 2022
...
"""
draw_hand_pts_lines:
    annotate joint positions on fingers for finger segmentation
    input:
        hand image
        coordinations of joints
        thumb_colour   : [red, green, blue]
        index_colour   : [red, green, blue]
        middle_colour  : [red, green, blue]
        ring_colour    : [red, green, blue]
        pinky_colour   : [red, green, blue]
    out:
...
"""
getPrediction:
    predict finger function
    input:
        dictionary of inputed image
    out:
        predicted result (str)
        display image : this image contains a hand image and predicted results
...
def getPrediction(filename):
    ...
    # Load model
    model = models.load_model("model/model_finger_assessment.h5",compile=False)
    ...
    # Read image
    sample_img_color = cv2.imread(filename)
    ...
    index_area = resize(index_area, [256, 64, 3])
    ...
    midl_area = resize(midl_area, [256, 64, 3])
    ...
    ring_area = resize(ring_area, [256, 64, 3])
    ...
    picky_area = resize(picky_area, [256, 64, 3])
    ...
    return out_put, sample_img_color
